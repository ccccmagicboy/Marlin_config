...
#NEOPIXEL_BRIGHTNESS########################################################################################################
subprocess.call(shlex.split('{0:s}/buildroot/bin/opt_set NEOPIXEL_BRIGHTNESS {1:s}'.format(os.getcwd(), '100')))
print(colored('The Initial brightness of neopixel led is set to {0:s}(hex).'.format('100'), "green"))
#NEOPIXEL_TYPE########################################################################################################
